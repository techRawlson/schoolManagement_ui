...
const StudentDetails = () => {
    ...
    const getStudent = async () => {
        try {
            const data = await fetch(`http://3.111.52.90:8082/api/students/${id}`)
    ...
    const submitStudent = async (e) => {
        ...
        try {
            ...
            const data = await fetch(`http://3.111.52.90:8082/api/students/update-student/${student[0]?.studentId}`, {
                method: 'PUT',
                headers: {
            ...
            const picture = await fetch(`http://3.111.52.90:8082/api/images/${student[0]?.studentId}`, {
                method: 'PUT',
                body: formData2,
            })
            console.log(picture)
                ...
                <Flex mb="5" justifyContent="space-between" alignItems="center" width="90vw">
                    ...
                    <Flex >
                        <label htmlFor={`avatar-upload-${id}`}>
                            <Avatar
                                src={image || `http://3.111.52.90:8082/api/images/${student[0]?.studentId}`}
                                alt="Avatar"
